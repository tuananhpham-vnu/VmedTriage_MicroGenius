...
TEXT_RED_FLAG_RULES: tuple[TextRedFlagRule, ...] = (
    ...
    rule(
        "paracetamol_overdose_pattern",
        "Dùng nhiều chế phẩm chứa paracetamol",
        "nhiều chế phẩm chứa paracetamol",
        "dùng nhiều chế phẩm chứa paracetamol",
        "uống nhiều paracetamol",
    ...
    rule(
        ...
        "Dấu hiệu suy gan cấp kèm rối loạn ý thức",
        "vàng mắt lơ mơ",
        "vàng mắt lú lẫn",
        "scleral icterus",
        "asterixis",
