...
Thu muc nay chua tai lieu san pham, kien truc, checklist, wireframe va guidebook. Neu ban muon hieu bai toan truoc khi doc code, bat dau tu `brief.md`, `prd.md`, roi `architecture_diagram.md`.

## File va folder

| Duong dan | Lam gi |
|---|---|
| `brief.md` | Tom tat bai toan/san pham. |
